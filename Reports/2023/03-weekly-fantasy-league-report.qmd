...
round_2_json <- jsonlite::fromJSON("../../Data/Fantasy-League-Scores/2023-ROUND-02-SCORES.json", simplifyDataFrame = TRUE)
...
scores <-
  get_fantasy_data(season = 2023, round_number = 2) |>
